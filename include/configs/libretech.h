...
#define LC_ETHEREALOS_TEST_LOAD_SPI \
	"etherealos_test_load_spi=" \
		...
		"fi\0"
#define LC_ETHEREALOS_CALC_MMC_BLK \
	"etherealos_calc_mmc_blk=" \
		"setexpr etherealos_offset_blk $etherealos_offset / $etherealos_mmc_blk_size; " \
		"setexpr etherealos_blk_roundup_add $etherealos_mmc_blk_size - 0x1; " \
		"setexpr etherealos_size_blk $etherealos_size + $etherealos_blk_roundup_add; " \
		"setexpr etherealos_size_blk $etherealos_size_blk / $etherealos_mmc_blk_size;\0"
#define LC_ETHEREALOS_TEST_LOAD_SD \
	"etherealos_test_load_sd=" \
		"if test $boot_source = \"sd\"; then " \
			"run etherealos_calc_mmc_blk; " \
			"time read mmc 0 $pxefile_addr_r $etherealos_offset_blk $etherealos_size_blk; " \
		"fi\0"
#define LC_ETHEREALOS_TEST_LOAD_EMMC \
	"etherealos_test_load_emmc=" \
		"if test $boot_source = \"emmc\"; then " \
			"run etherealos_calc_mmc_blk; " \
			"time read mmc 1 $pxefile_addr_r $etherealos_offset_blk $etherealos_size_blk; " \
		"fi\0"
#define LC_ETHEREALOS_BOOTCMD \
	"bootcmd_etherealos=" \
		"if test $etherealos_size -gt 0; then " \
			"run etherealos_test_load_spi || " \
			"run etherealos_test_load_sd || " \
			"run etherealos_test_load_emmc; " \
			"if test $? -eq 0; then " \
...
#define LC_ETHEREALOS_ENV \
	...
	"etherealos_mmc_blk_size=0x200\0" \
	LC_ETHEREALOS_CALC_MMC_BLK \
